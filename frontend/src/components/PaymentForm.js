...
const PaymentForm = ({ token, onTransactionUpdate }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-lg max-w-md mx-auto text-center">
      <h2 className="text-2xl font-bold text-orange-700 mb-6">Send Funds</h2>
        ...
        <form onSubmit={handlePreview} className="space-y-4">
          <div className="space-y-2">
            ...
            <input
              ...
              required
              className="w-full p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-all"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full py-3 mt-4 bg-gradient-to-r from-orange-500 to-red-600 text-white font-bold rounded-lg shadow-lg hover:from-orange-600 hover:to-red-700 transform transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2"
          >
            Preview Payment
          </button>
        </form>
